<?php 
	...
	wp_register_script('bootstrap_js', 'https://maxcdn.bootstrapcdn.com/bootstrap/3.3.7/js/bootstrap.min.js', array('jquery'), '3.3.7', false);
	wp_register_script('scripts', get_parent_theme_file_uri('/js/script.js'), /*array() si dependo de otro script, podría ser jquery*/null, '1.0', false); /*true= footer - false= header*/
