...
function lawyeria_lite_enqueue_style() {
    wp_register_style('custom', get_parent_theme_file_uri('/css/custom.css'), null, 'Version');
    wp_register_style('lato', 'https://fonts.googleapis.com/css?family=Lato', null, 'Version');
